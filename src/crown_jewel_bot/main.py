...
def _build_signed_approve_url(incident_id: str, service_account_email: str, severity: str, pipeline: str) -> str:
    ...
    sign_payload = f"{incident_id}|{service_account_email}|{severity}|{pipeline}|{issued_at}"
    signature = hmac.new(
